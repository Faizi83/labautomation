...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_POST['submit'])) {
            ...
            $login_query = "SELECT user_id, first_name, last_name, email, password FROM register WHERE email = :email OR user_id = :email";
            $login_query_prepare =  $connection->prepare($login_query);
            $login_query_prepare->bindParam(':email', $email);
