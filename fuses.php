...
if (isset($_POST['submit'])) {
    ...
    // $product_unique__id = "INSERT INTO `fuses` (`product_unique_id`) VALUES ('$product_rand_id')";
    
    
    $product_unique_id = $uniqueCode;
    ...
    // $prepARE = "INSERT INTO `fuses` (`product_unique_id`) VALUES ('$uniqueCode')";


    $insert_query = "INSERT INTO `fuses`(`product_unique_id`,`username`, `date`, `testing_type`, `description`) VALUES (:product_unique_id,:username, :date, :testing_type, :desc)";
    $insert_query_prepare = $connection->prepare($insert_query);

    $insert_query_prepare->bindParam(':product_unique_id', $product_unique_id, PDO::PARAM_STR);
                    ...
                    <div class="col-lg-7 mx-auto">
                        <div class="card mt-2 mx-auto p-4 bg-light">
                            <div class="card-body bg-light">
                                ...
                                <div class="container">
                                    <form action="fuses.php" id="contact-form" role="form" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="form_name" type="text" name="username" class="form-control" required="required" data-error="Username is required.">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date" class="form-control" required="required" data-error="date is required.">
