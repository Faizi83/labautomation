...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <a class="nav-link collapsed" href="tester_fild.php">
            <i class="fas fa-fw fa-table"></i>
            <span>Tester Feild</span>
        </a>
    </li>
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <?php foreach ($category_data as $data) { ?>
                    <a class="collapse-item" href="fuses.php?name=<?= $data['category_name'] ?>"><?= $data['category_name'] ?></a>
                <?php } ?>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Login Screens:</h6>
                <a class="collapse-item" href="tested_data.php">Tested Product</a>
                <!-- <a class="collapse-item" href="404.php">Passed</a>
                        <a class="collapse-item" href="404.php">Failed</a> -->
                <!-- <a class="collapse-item" href="forgot-password.php">Forgot Password</a> -->
                <div class="collapse-divider"></div>
                <h6 class="collapse-header">Other Pages:</h6>
                <a class="collapse-item" href="404.php">404 Page</a>
