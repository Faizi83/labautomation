...
if(isset($_POST['submit'])) 
		{
         ...
         $insert_query = "INSERT INTO `resistors`(`username`, `date`, `rating`, `testing_type`, `description`) VALUES (:username, :date, :rating, :testing_type, :desc)";
    ...
    <div id="wrapper">
        ...
        <!-- Navbar End -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 style="color: rgba(31, 28, 28, 0.726);"  class="h3 mb-4 font-weight-bold  text-center">Resistors Testing</h1>
                    <hr>
                        ...
                        <form action="#" id="contact-form" role="form" method="post">
                            ...
                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="form_email">Resistor Rating (Ω)</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="form_need" name="testing-type" class="form-control" required="required" data-error="Please specify your need.">
                                                ...
                                                <option >Resistance Measurement</option>
                                                <option >Temperature Test</option>
                                                <option >Noise Test</option>
